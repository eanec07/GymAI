...
TRANSLATIONS["es"].update({
    ...
    "Use recommended adjustment": "Usar el ajuste recomendado", "Train as planned": "Entrenar según lo planeado", "Today’s training status": "Estado de entrenamiento de hoy", "Today’s choice:": "Elección de hoy:", "Your base plan is unchanged.": "Tu plan base no cambia.", "Exercise info": "Información del ejercicio", "Replace exercise": "Reemplazar ejercicio", "Save note": "Guardar nota", "Finish workout": "Finalizar entrenamiento",
})
